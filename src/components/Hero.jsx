...
const Hero = () => {
  return (
    <section className="relative w-full h-screen mx-auto overflow-hidden bg-[#050816]">
      ...
      {/* Text overlay — positioned on top of the canvas, containing the line */}
      <div
        className={`${styles.paddingX} absolute inset-0 top-[90px] max-w-7xl mx-auto flex flex-row items-start gap-5 z-10 pointer-events-none`}
      >
